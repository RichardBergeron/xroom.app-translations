export default {
  ...
  on: 'ouvert',
  off: 'fermé',
  title: 'Besoin d’une salle de réunion/discussion?',
  buttons: {
    ok: 'OK',
    yes: 'Oui',
    no: 'Non',
  ...
  mbox: {
    ...
    oops: 'Désolé',
    kickedOutText: 'Désolé, vous avez été sorti de la salle',
  ...
  modes: {
    1: 'Réunion/discussion,
    2: 'Conférence/présentation/formation',
  },
  pre: {
    ...
    roomIsBusyWebinar: 'Une présentation est en cours d’exécution (%s × 🙂)',
    roomIsBusyConference: 'Une réunion est en cours d’exécution (%s × 🙂)',
